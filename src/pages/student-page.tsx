  ...
  return (
    <div className="container-fluid bg-slate-200 p-6">
      ...
      <div className="block p-4 my-6">
        ...
        <span className="flex">Address: {address}<HiPencil /></span>
        <span className="flex">Email: {email}<HiPencil /></span>
        <span className="flex">Phone: {phone}<HiPencil /></span>
        <span className="flex">Gender: {gender}<HiPencil /></span>
        <span className="flex">Birthday: {birthday}<HiPencil /></span>
        <span className="flex">LTO Client ID: {ltoClientId}<HiPencil /></span>
        <span className="flex">Registration Date: {createdAt && moment(createdAt).format('MMMM DD, YYYY')}</span>
      </div>
      ...
      <div className="block shadow-md border-s-8 border-blue-800 rounded-md p-4 mb-4">
        ...
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {
                  enrollment?.map(({ student, course, branch, createdAt, exam, ...enrollment }: any) => (
                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">
                        <button className="flex align-middle justify-center items-center bg-black text-white px-2 rounded-md mb-2 w-full">View Attendance</button>
                        <button className="flex align-middle justify-center items-center bg-black text-white px-2 rounded-md mb-2 w-full">View Exam Result</button>
                        <button className="flex align-middle justify-center items-center bg-black text-white px-2 rounded-md mb-2 w-full">Upload Files</button>
                      </td>
                  </tr>
                  ))
                }
