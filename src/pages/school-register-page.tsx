    ...
    <div className="container-fluid grid grid-cols-2 sm:grid-cols-1 lg:grid-cols-2 bg-slate-200 min-h-screen">
      ...
      <div className="p-20">
        <div className="block mb-6">
            <label htmlFor="" className='block'>Driving School Name</label>
            <Input type="text" placeholder="eg. A1C Driving School" callback={setName} />
          </div>
          <div className="block mb-6">
            <label htmlFor="" className='block'>Driving School Administrator Email</label>
            <Input type="email" placeholder="eg. driving.school@email.com" callback={setEmail} />
          </div>
          <div className="block mb-6">
            <label htmlFor="" className='block'>Driving School Phone Number</label>
