...
export default function StudentRegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    if (!email || !password || !firstName || !lastName || !phone || !gender || !branch || !address || !birthday) {
  ...
  useEffect(() => {
    schoolService.getSchoolById('65f690bff6ffc0dbad940701')
  ...
  return (
    <div className="container-fluid bg-slate-200 p-20">
      <h1 className='font-bold text-3xl mb-4 border-s-8 border-blue-800 ps-2'>Enroll by creating a student account</h1>
      <p>Fill out personal information and choose your branch & course in order to proceed with the enrollment.</p>
      ...
      <div className="inline-block p-4">
        <label htmlFor="" className='block'>Suffix</label>
        <Input type="text" placeholder="eg. Jr, Sr, III" callback={setSuffix} />
      </div>
      <div className="inline-block p-4">
        <label htmlFor="" className='block'>Birthday</label>
      ...
      <div className="inline-block p-4">
        ...
        <Select className='' onChange={(e) => { setGender(e.target.value) }} required>
      ...
      <div className="inline-block p-4">
        <label htmlFor="" className='block'>Pick Your Branch</label>
        <Select className='' onChange={(e) => { setBranch(e.target.value) }} required>
      ...
      <div className="inline-block p-4">
        <label htmlFor="" className='block'>Courses</label>
        <Select className='' onChange={(e) => { setCourse(e.target.value) }} required>
      ...
      <div className="block mb-4">
        ...
        <small className='block mt-1 text-gray-600'>By clicking the register button, you agree to our data privacy and terms & conditions.</small>
        <br />
        
        <a href="/student/login" className='block text-blue-800'>I have an account, login instead</a>
      </div>
    </div>  
  )
}
